...
**Panya** คือแพลตฟอร์ม SaaS ที่ใช้ AI เป็นหัวใจหลัก ทำหน้าที่เป็น "สมองธุรกิจ" ให้กับร้านค้าและร้านอาหารขนาดเล็ก-กลาง ในเชียงใหม่และภาคเหนือ ระบบรวม 4 AI Brain modules ไว้ในที่เดียว ช่วยให้เจ้าของร้านคนเดียวสามารถทำงานได้เหมือนมีทีม Marketing + Data Analyst + Customer Service
